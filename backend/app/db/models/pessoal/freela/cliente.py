...
class Cliente(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    projetos_publicados: Mapped[Optional[int]] = mapped_column(Integer)
    projetos_pagos: Mapped[Optional[int]] = mapped_column(Integer)
    pagamento_verificado: Mapped[bool] = mapped_column(
        Boolean, default=False, server_default="false", nullable=False
    )
    membro_desde: Mapped[Optional[str]] = mapped_column(String(50))
