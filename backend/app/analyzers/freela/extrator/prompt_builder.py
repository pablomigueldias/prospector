...
OUTPUT_SCHEMA = """
{
  ...
  "n_propostas_concorrentes": <inteiro de propostas/interessados já feitas, ou null>
}
"""
...
- "n_propostas_concorrentes": quantas propostas/interessados o texto menciona
  (ex.: "64 propostas" → 64). Se não mencionar, null.
