...
def to_response(usuario: Usuario, permissoes: Optional[List[str]] = None) -> UsuarioResponse:
...
def ip_do_request(request: Request) -> Optional[str]:
...
def user_agent_do_request(request: Request) -> Optional[str]:
