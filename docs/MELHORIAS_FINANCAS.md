...
- ✅ **Lembrar categoria por beneficiário** (2026-06-13) — ao importar sem informar categoria, reaproveita a do último boleto do mesmo beneficiário (auto-categoriza condomínio/escola etc.); a mensagem avisa "categoria reaproveitada". `TransacaoRepository.ultima_categoria_por_descricao`. (Conta sugerida no pagamento fica como follow-up.)
