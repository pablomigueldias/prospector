...
- **Auto-categoria por beneficiário (2026-06-13):** importar um boleto sem escolher categoria reaproveita a categoria do último boleto do mesmo beneficiário (condomínio, escola…) — para de recategorizar todo mês. O card de import avisa "categoria reaproveitada".
