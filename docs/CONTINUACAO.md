...
- **Relatório mensal (2026-06-11):** seção **Relatório** no dashboard com a série de 3/6/12 meses (receitas × despesas em barras), saldo por mês, totais + despesa média, top categorias do período e **export CSV** (`GET /api/financas/resumo/relatorio`).
